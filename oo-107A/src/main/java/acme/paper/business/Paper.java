...
@Table(name = "papers")
    ...
    @DateTimeFormat(pattern = "yyyy-MM-dd") // NEW: Add this annotation
    private Date publishedDate;    private String abstractText; // 'abstract' is a reserved keyword in Java
