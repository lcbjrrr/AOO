...
public class AppFacade {
    ...
    // --- AUTHOR MANAGEMENT FACADE METHODS (Corresponds to AuthorManager) ---

    /**
     * Adds a new Author to the system.
     * @param author The Author object to add.
     * @throws AuthorAlreadyRegisteredException if an Author with the same unique identifier (email) already exists.
     */
    ...
    // --- PAPER MANAGEMENT FACADE METHODS (Corresponds to PaperManager) ---

    /**
     * Adds a new Paper to the system.
     * @param paper The Paper object to add.
     * @throws PaperAlreadyExistsException if a Paper with the same unique identifier (entryId) already exists.
     */
