...
public class AuthorRepositoryDB implements IAuthorRepository {
    ...
    private static final String DB_URL = "jdbc:sqlite:paper.db"; // Database file name
    ...
    private void createAuthorsTable() {
        ...
        try (Connection conn = getConnection();
            ...
            stmt.execute(sql);
            System.out.println("Authors table created or already exists.");
        } catch (SQLException e) {
            System.err.println("Error creating Authors table: " + e.getMessage());
        }
    }

    // Helper method to map ResultSet to an Author object
